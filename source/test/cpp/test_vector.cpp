...
UNITTEST_SUITE_BEGIN(vector_t)
{
    UNITTEST_FIXTURE(main)
    {
        UNITTEST_TEST(create_destroy)
        {
            ...
            CHECK_GE(vector_get_capacity(&v), (u32)128);
        ...
        UNITTEST_TEST(item_access_and_mutation)
        {
            ...
            CHECK_EQUAL((u32)99, vector_get_size(&vector));
        ...
        UNITTEST_TEST(capacity_and_empty_boundaries)
        {
            ...
            CHECK_TRUE(vector_set_capacity(&vector, 6));
            CHECK_GE(vector_get_capacity(&vector),(u32)6);
            CHECK_TRUE(vector_set_capacity(&vector, 0));
